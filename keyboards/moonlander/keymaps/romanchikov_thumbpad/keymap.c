...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MACR1] = LAYOUT_moonlander(
        ...
        _______,             _______,          LCMD(KC_LEFT),     LCMD(KC_DOWN),     LCMD(KC_RGHT),     _______,           LALT(LCTL(KC_N)),                   _______,           _______,           MS_BTN1,           _______,           _______,           _______,              LNG,
        _______,             _______,          _______,           _______,           EQUM,              LCMD(KC_X),                                                               _______,           _______,           _______,           _______,           _______,              KC_ENTER,
