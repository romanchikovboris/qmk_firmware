...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] = LAYOUT_moonlander(
        KC_ESC,             KC_EXLM,           KC_AT,             KC_HASH,           KC_DLR,            KC_PERC,           LCMD(KC_W),                         LCMD(LSFT(KC_B)),  KC_CIRC,           KC_AMPR,           KC_ASTR,           KC_LPRN,           KC_RPRN,              _______,
        ...
        MO(MACR2),          KC_Z,              KC_X,              KC_C,              KC_V,              KC_B,                                                                     KC_N,              KC_M,              KC_COMM,           KC_COMM,           KC_QUOTE,             _______,
        MO(MACR3),          KC_LCTL,           KC_LALT,           KC_DOT,            MO(SYMB),                             KC_LCMD,                            KC_ENTER,                             MO(SYMB),          KC_GRV,            KC_COMM,           _______,        LSFT(KC_MINS),
    ...
    [GAME] = LAYOUT_moonlander(
        _______,            KC_1,              KC_2,              KC_3,              KC_4,              KC_5,              KC_B,                               _______,           KC_6,              KC_7,              KC_8,              KC_9,              KC_0,                 _______,
        KC_TAB,             KC_TAB,            KC_Q,              KC_W,              KC_E,              KC_R,              KC_T,                               _______,           _______,           _______,           _______,           _______,           _______,              _______,
        KC_LSFT,            KC_LSFT,           KC_A,              KC_S,              KC_D,              KC_F,              KC_G,                               _______,           _______,           _______,           _______,           _______,           _______,              _______,
        KC_LCTL,            KC_LCTL,           KC_Z,              KC_X,              KC_C,              KC_V,                                                                     _______,           _______,           _______,           _______,           _______,              _______,
        _______,            KC_LALT,           _______,           _______,           _______,                              KC_B,                               _______,                              _______,           _______,           _______,           _______,              _______,
    ...
    [SYMB] = LAYOUT_moonlander(
        ...
        _______,             KC_LBRC,          KC_RBRC,           KC_UP,             KC_LPRN,           KC_RPRN,           _______,                            _______,           LSFT(KC_EQL),      KC_1,              KC_2,              KC_3,              _______,              _______,
        KC_SLSH,             KC_LCMD,          KC_LEFT,           KC_DOWN,           KC_RGHT,           _______,           _______,                            _______,           KC_MINS,           KC_4,              KC_5,              KC_6,              KC_LCTL,              _______,
        _______,             LSFT(KC_LBRC),    LSFT(KC_RBRC),     LSFT(KC_COMM),     LSFT(KC_DOT),      _______,                                                                  KC_EQL,            KC_7,              KC_8,              KC_9,              _______,              _______,
