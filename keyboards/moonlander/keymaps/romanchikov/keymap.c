...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] = LAYOUT_moonlander(
        ...
        MO(MACR3),          KC_LCTL,           KC_LALT,           KC_DOT,            MO(SYMB),                             KC_LCMD,                            KC_ENTER,                             MO(SYMB),          KC_GRV,            KC_COMM,           LALT(KC_LSFT),        LSFT(KC_MINS),
                                                                                     KC_SPC,            KC_BSPC,           KC_LSFT,                            LNG,               _______,           _______ 
    ),
    ...
    [MACR1] = LAYOUT_moonlander(
        ...
        _______,             _______,          _______,           _______,           RET,               _______,           _______,                            _______,           _______,           _______,           _______,           _______,           _______,              _______,
        _______,             ACTION,           SPROP,             _______,           _______,           MEQU,              _______,                            _______,           _______,           _______,           _______,           _______,           _______,              _______,
        _______,             _______,          _______,           CLC_LSN,           _______,           PEQU,                                                                     _______,           _______,           _______,           _______,           _______,              _______,
