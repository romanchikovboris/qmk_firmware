...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_moonlander(
        KC_ESC,             KC_EXLM,           KC_AT,             KC_HASH,           KC_DLR,            KC_PERC,           CMB_008,                            CMB_018,           KC_CIRC,           KC_AMPR,           KC_ASTR,           KC_LPRN,           KC_RPRN,              LCA(KC_DEL),
        CMB_011,            KC_Q,              KC_W,              KC_E,              KC_R,              KC_T,              CMB_009,                            CMB_019,           KC_Y,              KC_U,              KC_I,              KC_O,              KC_P,                 KC_BSLS,
        CMB_012,            KC_A,              KC_S,              KC_D,              KC_F,              KC_G,              CMB_010,                            CMB_020,           KC_H,              KC_J,              KC_K,              KC_L,              CMB_015,              CMB_016,
        CMB_013,            KC_Z,              KC_X,              KC_C,              KC_V,              KC_B,                                                                     KC_N,              KC_M,              KC_COMM,           KC_COMM,           CMB_027,              CMB_025,
        CMB_014,            KC_LCTL,           LCTL(KC_LALT),     CMB_030,           CMB_031,                             CMB_000,                            CMB_004,                              MO(SYMB),          KC_GRV,            KC_COMM,           LALT(KC_LSFT),        CMB_026,
                                                                                     CMB_001,           CMB_002,           CMB_003,                            CMB_005,           CMB_006,           CMB_007 
    ),
    ...
    // ),
	  ...
	  [RU] = LAYOUT_moonlander(
        ...
        _______,            _______,           _______,           _______,           _______,                              _______,                            _______,                              _______,           _______,           LSFT(KC_SLSH),     _______,              _______,
                                                                                     _______,           _______,           CMB_017,                            _______,           _______,           _______
    ),

    [GAME] = LAYOUT_moonlander(
        _______,           _______,           _______,           _______,           _______,           _______,           CMB_023,                            _______,           _______,           _______,           _______,           _______,           _______,              _______,
        _______,           KC_TAB,            KC_Q,              KC_W,              KC_E,              KC_R,              CMB_024,                            _______,           _______,           _______,           _______,           _______,           _______,              _______,
    ...
    [MACRO] = LAYOUT_moonlander(
        ...
        _______,            _______,           _______,           _______,           RET,               _______,           _______,                            _______,           _______,           _______,           IFN,            _______,           _______,              _______,
        _______,            ACTION,            SPROP,             _______,           _______,           _______,           _______,                            _______,           _______,           _______,           _______,           LABEL,             _______,              _______,
        _______,            _______,           _______,           CLC_LSN,           _______,           BUTTON,                                                                   CMB_021,           CMB_022,           _______,           _______,           _______,              _______,
        _______,            _______,           _______,           _______,           _______,                              _______,                            _______,                              _______,           _______,           _______,           _______,              _______,
                                                                                     _______,           _______,           _______,                            _______,           _______,           _______
    ),
    ...
    [SYMB] = LAYOUT_moonlander(
        ...
        _______,            CMB_028,           CMB_029,           KC_UP,             KC_LPRN,           KC_RPRN,           _______,                            _______,           _______,           KC_1,              KC_2,              KC_3,              _______,              _______,
        KC_SLSH,            KC_LCMD,           KC_LEFT,           KC_DOWN,           KC_RGHT,           KC_MINS,           _______,                            _______,           _______,           KC_4,              KC_5,              KC_6,              KC_LCTRL,             _______,
